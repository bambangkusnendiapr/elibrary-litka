            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                  @foreach($pengarang as $e=>$p)
                  <tr>
                    <td>{{ $e+1 }}</td>
                    <td>{{ $p->pengarang_nama }}</td>
                    <td>{{ $p->pengarang_ket }}</td>
                    <td>
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="{{ route('pengarang.store') }}" id="form_tambah">
              {{ csrf_field() }}
              <div class="box-body">
  ...
  <div class="modal fade" id="modal-edit{{$p->id}}">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="{{ route('pengarang.update',$p->id) }}" id="form_tambah">
          @csrf
          @method('patch')
              <div class="box-body">
                  <div class="form-group">
                    <label for="nama">Nama Pengarang</label>
                    <input type="text" required name="nama" class="form-control kategori_nama" id="kategori_nama" value="{{ $p->pengarang_nama }}">
                  </div>
                  <div class="form-group">
                      <label for="ket">Keterangan Kategori</label>
                      <textarea class="form-control summernote kategori_ket" name="ket" id="kategori_ket">{{ $p->pengarang_ket }}</textarea>
                  </div>
              </div>
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        ...
        <div class="modal-body">
          <div class="container">
            <div class="row">
              ...
              <form action="{{ route('pengarang.destroy', $p->id) }}" method="post" class="d-inline" id="id_form">
              @method('delete')
              @csrf
